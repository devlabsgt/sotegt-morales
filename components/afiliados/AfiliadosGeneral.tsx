                    ...
                    <table className="min-w-full bg-white text-xs">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {todosOrdenados.map(({ afiliado, tipo, depth }, index) => (
                          <tr
                            key={afiliado.id}
                            className={`uppercase ${tipo === "lider"
                          ...
                          >
                            ...
                            <td className={`px-4 py-2 whitespace-nowrap font-bold ${tipo === "lider" ? "text-orange-800" : tipo === "familiar" ? "text-purple-800" : "text-blue-800"
                              }`}>

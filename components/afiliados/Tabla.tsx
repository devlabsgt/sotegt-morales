              ...
              <div className="p-4 flex-1 space-y-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-gray-100 pb-3 gap-1 md:gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    <span
                      className={`flex items-center justify-center font-bold text-xs h-6 w-6 rounded-md shrink-0 ${esLider
                ...
                <div className="pt-1">
                  {afiliado.empadronado ? (
                    <div className={`border rounded p-2 flex items-center gap-2 ${esFamiliar
